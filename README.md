...
[![GitHub Stars](https://img.shields.io/github/stars/josedcs/strategy-testast?style=for-the-badge&logo=github)](https://github.com/josedcs/strategy-testast)
...
```bash
# Clone repository
git clone https://github.com/josedcs/strategy-testast.git
cd strategy-testast
...
```python
from strategy import TEstastStrategy
...
- **Documentation**: [Wiki](https://github.com/josedcs/strategy-testast/wiki)
- **Issues**: [GitHub Issues](https://github.com/josedcs/strategy-testast/issues)
- **Discussions**: [GitHub Discussions](https://github.com/josedcs/strategy-testast/discussions)
